...
function submitAnswer(result) {
  document.querySelector("#mathForm").addEventListener("submit", function(e) {
    ...
    if (bool === true) {
      ...
      setTimeout(function() {
        document.body.style.backgroundColor = "#DFD3E3";
      }, 1000);
      // Clear input field
      ...
      setTimeout(function() {
        document.body.style.backgroundColor = "#30D5C8";
      }, 1000);
    }
  });
}
...
function randomCreator() {
  ...
  el.innerHTML = ("Sa jane ").concat(randomIntOne, " ", randomOperator, " ", randomIntTwo, "?");
